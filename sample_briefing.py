SAMPLE_COMPANY_NAME = "Creatio"
SAMPLE_JOB_TITLE = "Account Executive"
...
SAMPLE_RESULT = {
    ...
    "culture": (
        ...
        "commitment to employee wellbeing. The job description emphasizes creativity, "
        "accountability, and ambition — this is not a coast-and-collect culture. Collaboration "
        "is called out repeatedly, including cross-functional work with SDRs, Marketing, "
        "Solutions Consulting, and Customer Success, so siloed lone-wolf sellers won't thrive "
        "here."
    ),
    "experience_level": (
    ...
    "company_explainer": (
        ...
        "AI-powered agents without writing code. Think of it as a tool that lets a sales, "
        "service, or ops team automate their processes — routing leads, managing cases, "
        "triggering follow-ups — without needing a developer. They compete in the CRM and "
        "business process automation space alongside players like Salesforce, HubSpot, and "
        "Microsoft Power Platform, and differentiate on speed-to-value and ease of "
        "customization. They serve thousands of clients across 100+ countries and are "
        "recognized as a Leader/Strong Performer in Gartner and Forrester reports."
    ),
    "locations": (
        "Creatio is headquartered globally (Boston, MA area in the US per public knowledge, "
...
SAMPLE_STAGES = [
    ...
    "Researching Creatio and scanning their site...",
